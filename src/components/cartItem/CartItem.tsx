    ...
    return (
        <div className={styles["item"]}>
            ...
            <div className={styles["item-title"]}>
                <h5>{item.name}</h5>
                {item.sizes !== undefined && item.types !== null ? (
                    <span>{` ${item.types}, ${item.sizes}`} см.</span>
                ) : null}
            </div>
            ...
            <div className={styles["item_count"]}>
                ...
                <div onClick={incrementBasketItems}>
                    <svg
                        width="32"
                        height="32"
                        style={{ cursor: "pointer" }}
            ...
            <div onClick={removeBasketItems} className={styles["item_close"]}>
                <svg
                    width="32"
                    height="32"
                    viewBox="0 0 32 32"
